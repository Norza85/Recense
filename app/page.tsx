    ...
    <main className="min-h-screen bg-paper text-ink">
      ...
      <section className="px-6 pt-16 pb-12 max-w-xl mx-auto text-center">
        <p className="text-sm font-semibold text-accent uppercase tracking-wide">
          Pour les PME de 10 à 100 salariés
        </p>
        ...
        <p className="mt-4 text-lg text-ink/70">
          Recense repère en quelques minutes les abonnements oubliés, les
          doublons entre équipes, et vous alerte avant chaque renouvellement.
        </p>
        <a
          href="#essai"
        ...
        >
          Voir mes économies possibles
        </a>
        <p className="mt-3 text-sm text-ink/50">
          Gratuit à l'inscription — 79€/mois ensuite
        </p>
      </section>
      ...
      <section className="px-6 py-10 bg-ink text-paper">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="mt-2 text-lg">
            ...
            sert plus à rien — sans que personne ne le sache.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-14 max-w-xl mx-auto">
        <div className="space-y-8">
          <div className="border-l-4 border-accent pl-4">
            <h3 className="font-bold text-lg">Tout votre parc, en un coup d'œil</h3>
            <p className="mt-1 text-ink/70">
              Chaque outil, son coût annuel, qui l'utilise — fini les
              abonnements éparpillés entre services.
            </p>
          </div>
          <div className="border-l-4 border-accent pl-4">
            <h3 className="font-bold text-lg">Les doublons démasqués</h3>
            <p className="mt-1 text-ink/70">
              Deux équipes qui payent deux outils pour la même chose ? Recense
              vous le signale avant que ça devienne une habitude.
            </p>
          </div>
          <div className="border-l-4 border-accent pl-4">
            <h3 className="font-bold text-lg">Jamais surpris par un renouvellement</h3>
            <p className="mt-1 text-ink/70">
              Une alerte avant chaque échéance annuelle, le temps de décider
      ...
      <section className="px-6 py-10 bg-ink/5">
        <div className="max-w-xl mx-auto text-center">
          <p className="text-sm text-ink/50 italic">
            [Emplacement réservé — témoignages clients à venir]
          </p>
        </div>
      </section>
      ...
      <section id="essai" className="px-6 py-16 max-w-xl mx-auto text-center">
        <h2 className="text-2xl font-bold">Prêt à voir ce que vous payez pour rien ?</h2>
        <a
          href="/inscription"
